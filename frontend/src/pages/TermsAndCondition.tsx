...
export default function PrivacyPolicy() {
  ...
  return (
    <Layout>
      <div className="px-6 md:px-12 lg:px-24 py-8 md:py-16 font-[Manrope]">
        <div className="mx-auto bg-white rounded-2xl overflow-hidden">
          ...
          <div className="lg:px-8 md:py-0 lg:py-10 md:px-4">
            <article className="markdown-content">
              <ReactMarkdown
                ...
                components={{
                  h1: ({node, ...props}) => (
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mt-8 mb-4 pb-3 border-b-2 border-blue-200" {...props} />
                  ),
                  h2: ({node, ...props}) => (
                    <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4 flex items-center gap-3" {...props}>
                      <span className="w-1.5 h-8 bg-[#2563EB] rounded-full"></span>
                  ...
                  th: ({node, ...props}) => (
                    <th className="px-6 py-4 text-left text-xs font-bold text-[#2563EB] uppercase tracking-wider" {...props} />
                  ),
                  td: ({node, ...props}) => (
                  ...
                  a: ({node, ...props}) => (
                    <a className="text-[#2563EB] hover:text-blue-700 underline font-medium transition-colors" {...props} />
                  ),
