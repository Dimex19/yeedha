...
export default function PrivacyPolicy() {
  ...
  return (
    <Layout>
      <div className="px-6 md:px-12 lg:px-24 py-16 font-[Manrope] bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">

          {/* Enhanced Header */}
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-10 md:px-12">
