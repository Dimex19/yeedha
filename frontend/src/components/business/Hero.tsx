      ...
      <div className="relative font-[Manrope] w-full">
        <div className="relative w-full">
          <img
            src={Rectangle41}
            alt="Hero"
            className="w-full h-[750px] sm:h-[800px] md:h-[900px] lg:h-[580px] object-cover"
          />

          <div className="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-black/70"></div>

          <div className="absolute inset-0 flex flex-col lg:flex-row justify-center lg:justify-between items-center lg:items-start px-6 sm:px-10 md:px-16 lg:px-[106px] top-[20%] lg:top-[28%] gap-10">
            
            {/* LEFT TEXT */}
            <div className="max-w-full lg:max-w-[60%] text-center lg:text-left lg:mt-16 ">
              ...
              <button 
                ...
                className="w-[180px] sm:w-[210px] text-white h-[50px] sm:h-[55px] bg-[#2563EB] rounded-[12px]">
                {cta.label}
              </button>
            </div>
