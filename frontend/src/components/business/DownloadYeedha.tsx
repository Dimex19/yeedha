...
const Download = () => {
  ...
  return (
    <div className="font-[Manrope] px-5 md:px-0 bg-[#2563EB] text-white mb-[131px] text-center pt-[66px] pb-[85px]">
      ...
      <div className="md:w-[564px] h-[40px] md:h-[50px] bg-white flex items-center justify-center rounded-[10px] mx-auto mt-[68px]">
        <button
      ...
      <div className="flex gap-[10.73px] mt-[35px] mx-auto justify-center">
              <div className="flex gap-1 font-[Manrope] w-[106px] md:w-[126px] px-[15.02px] py-[8px] md:py-[6.01px] h-[38px] bg-[#5586F0] rounded-[57.25px]">
