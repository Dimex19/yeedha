import Rectangle1009 from '../../assets/images/rectangle1009.png'
import Group10 from '../../assets/icons/group10.png'
import type { HealthInsuranceHeroBlock } from '../../utils/types/autoService'
import { getStrapiMedia } from "../../utils/StrapiImage";
const Hero = ({title, description, cta, image, imageText}: HealthInsuranceHeroBlock) => {
  return (
    <>
      <div className="relative mt-20 sm:mt-28 md:mt-36 lg:mt-44 mb-16 md:mb-24 lg:mb-36 font-[Manrope]">
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-10 lg:gap-0 px-5 sm:px-10 md:px-16 xl:px-[106px]">
