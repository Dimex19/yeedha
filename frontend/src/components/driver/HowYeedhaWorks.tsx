...
//   titleDesc,
  ...
  return (
    <div className="mt-[40px] md:mt-[56px] font-[Manrope]">
      {/* Header */}
      <div className="md:w-[849px] text-center mx-auto mb-10 md:mb-[83px]">
        <p className="text-[20px] md:text-[35px] text-[#2563EB]">
          {dynamicTitle && (
            <>
              How <b>{dynamicTitle.replace("How ", "").replace(" works", "")} Driver</b> app works
            </>
          )}
        </p>
        ...
        <div className="relative flex lg:justify-start xl:px-[84px]">
          ...
          {overlayImageSrc && (
            <img
              src={overlayImageSrc}
              alt="Overlay visual"
              className="absolute bottom-[0%] left-[40%] sm:top-[28%] md:top-[31%] lg:top-[28.5%] xl:top-[30%] md:left-[40%] xl:left-[57%] w-[60%] lg:w-[70%] xl:w-[60%]"
            />
          )}
        </div>
