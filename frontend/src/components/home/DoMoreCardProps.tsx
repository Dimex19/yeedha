...
const DoMoreCardProps = ({ image, title, description, BtnText }: DoMoreCardProp) => {
  return (
    <div className="relative mb-4 mx-2">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-white/30 rounded-[16px]"></div>

      {/* Content on top */}
      <div className="absolute top-1/2 pl-[30px] z-10">
        <p className="font-[Manrope] text-2xl lg:text-3xl xl:text-[42px] font-semibold text-white">{title}</p>
